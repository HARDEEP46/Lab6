...
<!-- STEP 9c: The below links don't work for the same reasons as the NAV in the HEADER - the href paths are wrong - we are ALREADY inside the 'about' folder, so the "about/" is not needed - remove it from the below two links, then try it out in a browser -->
				<a href="privacy-policy.php" title="Read our Privacy Policy">Privacy Policy</a> | <a href="privacy-policy.php#personal-information" title="Learn about how we treat your personal information">Use of Personal Information</a> | <a href="terms-of-use.php" title="Assigned rules and regulations for the users that all must agree to."> Terms Of Use</a> | <a href="terms-of-use.php#limitation-liability" title="Limitation-liability">Limitation of Liability</a>
